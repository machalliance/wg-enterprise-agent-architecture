...
Proposed artifacts are described in the [charter](./CHARTER.md#proposed-artifacts). Final artifacts will be added to a `deliverables/` directory as work begins.
