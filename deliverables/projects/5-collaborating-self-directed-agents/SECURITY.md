...
and no response-time commitment. Dependencies are pinned exactly and will go stale.

It is provided under the [MIT License](LICENSE), which means it comes **"as is", without warranty of any
kind**, and the authors and copyright holders are not liable for any claim, damage or other liability
