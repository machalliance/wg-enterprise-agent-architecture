...
class InMemoryRequestInsightsStore {
    recordSpan(span) {
        ...
        const spanEndTime = span.durationMs ? spanStartTime + span.durationMs : spanStartTime;
        const requestEndTime = insight.durationMs ? insight.startTime + insight.durationMs : insight.startTime;
        ...
        insight.durationMs = Math.max(requestEndTime, spanEndTime) - insight.startTime;
    ...
    recordFetch(identity, fetch) {
        ...
        const fetchEndTime = fetch.durationMs ? fetchStartTime + fetch.durationMs : fetchStartTime;
        const requestEndTime = insight.durationMs ? insight.startTime + insight.durationMs : insight.startTime;
