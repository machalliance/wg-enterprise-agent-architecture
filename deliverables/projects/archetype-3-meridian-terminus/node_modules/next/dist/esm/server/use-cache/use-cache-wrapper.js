...
import { NEXT_HMR_REFRESH_HASH_COOKIE, NEXT_INSTANT_TEST_COOKIE } from '../../client/components/app-router-headers';
            ...
            case 'request':
                {
                    if (process.env.NODE_ENV === 'development') {
                        ...
                        await makeDevtoolsIOAwarePromise(undefined, outerWorkUnitStore, // TODO(app-shells): exclude private caches with a short staletime
                        RENDER_STAGES_BY_DATA_KIND.sessionData);
                    }
                    break;
                }
