...
export declare function getSharp(concurrency: number | null | undefined, operationCache: boolean | null | undefined): typeof import("sharp");
 ...
 */
export declare function detectContentType(buffer: Buffer, skipMetadata: boolean | null | undefined, concurrency?: number | null | undefined, operationCache?: boolean | null | undefined): Promise<string | null>;
...
export declare function imageOptimizer(imageUpstream: ImageUpstream, paramsResult: Pick<ImageParamsResult, 'href' | 'width' | 'quality' | 'mimeType'>, nextConfig: {
    experimental: Pick<NextConfigComplete['experimental'], 'imgOptConcurrency' | 'imgOptOperationCache' | 'imgOptMaxInputPixels' | 'imgOptSequentialRead' | 'imgOptSkipMetadata' | 'imgOptTimeoutInSeconds'>;
