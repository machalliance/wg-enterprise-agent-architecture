...
function createLocalSpan({ name, attributes, links, traceId, spanId, parentSpanId, delegateSpan }) {
...
class LocalRecordingSpan {
    constructor({ name, attributes, links, delegateSpan, traceId, spanId, parentSpanId, requestIdentity }){
        this.name = name;
...
function getCurrentRequestIdentity() {
    try {
        ...
        return {
            requestId: workStore == null ? void 0 : workStore.requestId,
            htmlRequestId: workStore == null ? void 0 : workStore.htmlRequestId,
