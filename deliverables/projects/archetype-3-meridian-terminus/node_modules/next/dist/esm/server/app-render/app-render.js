 ...
 */ async function generateStagedDynamicFlightRenderResultNode(req, ctx, requestStore) {
    ...
    const shellByteLengthDeferred = appShells ? createPromiseWithResolvers() : null;
    ...
    const flightStream = await runInSequentialTasks(()=>{
        ...
        void countShellAndStaticStageBytes(staticStream, stageController).then((byteLengths)=>{
            ...
            shellByteLengthDeferred == null ? void 0 : shellByteLengthDeferred.resolve(byteLengths[RenderStage.ShellStatic]);
        });
...
async function prerenderToStream(req, res, ctx, metadata, tree, fallbackRouteParams) {
    ...
    let bootstrapScriptContent = renderOpts.experimental.exposeTestingApi ? await getInstantTestBootstrapScriptContent() : undefined;
