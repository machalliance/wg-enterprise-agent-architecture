...
class NextTracerImpl {
   ...
   */ runWithDetachedContext(fn) {
    ...
    trace(...args) {
        ...
        return context.with(spanContext.setValue(rootSpanIdKey, spanId), ()=>this.runWithActiveSpan(spanName, options, spanContext, tracingEnabled, localSpanRecordingEnabled, (span)=>{
                let startTime;
    ...
    startSpan(...args) {
        ...
        const parentContext = this.getSpanContext((options == null ? void 0 : options.parentSpan) ?? this.getActiveScopeSpan()) ?? context.active();
        const localSpanRecordingEnabled = ((_getLocalSpanRecorder = getLocalSpanRecorder()) == null ? void 0 : _getLocalSpanRecorder.isLocalSpanRecordingEnabled()) ?? false;
