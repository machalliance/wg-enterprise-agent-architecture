...
export default class ResponseCache {
   ...
   */ async get(key, responseGenerator, context) {
        ...
        const { incrementalCache, isOnDemandRevalidate = false, isFallback = false, isRoutePPREnabled = false, isPrefetch = false, appShells = false, waitUntil, routeKind, invocationID } = context;
   ...
   */ async handleGet(key, responseGenerator, context, resolve) {
        ...
        try {
            ...
            const incrementalResponseCacheEntry = context.isPrefetch && context.appShells && previousIncrementalCacheEntry === null ? await this.handleRevalidate(key, context.incrementalCache, context.isRoutePPREnabled, context.isFallback, responseGenerator, previousIncrementalCacheEntry, resolved) : await this.revalidate(key, context.incrementalCache, context.isRoutePPREnabled, context.isFallback, responseGenerator, previousIncrementalCacheEntry, resolved);
