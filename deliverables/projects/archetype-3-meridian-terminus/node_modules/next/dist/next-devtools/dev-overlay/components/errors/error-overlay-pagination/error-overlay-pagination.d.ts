...
export declare function ErrorOverlayPagination({ runtimeErrors, activeIdx, onActiveIndexChange, canGoPrevious, canGoNext, onPrevious, onNext, renderTabBar, }: ErrorPaginationProps): import("react/jsx-runtime").JSX.Element;
