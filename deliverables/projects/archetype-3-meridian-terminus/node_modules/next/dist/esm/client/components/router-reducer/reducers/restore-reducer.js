...
import { FreshnessPolicy, getCurrentNavigationLock, spawnDynamicRequests, startPPRNavigation } from '../ppr-navigations';
...
export function restoreReducer(state, action) {
    ...
    'replace', navigationLock, // Not an HMR refresh, so there's no request generation to cancel.
    undefined);
