 ...
 */ export async function detectContentType(buffer, skipMetadata, concurrency, operationCache) {
...
export async function imageOptimizer(imageUpstream, paramsResult, nextConfig, opts) {
    ...
    const upstreamType = await detectContentType(upstreamBuffer, nextConfig.experimental.imgOptSkipMetadata, nextConfig.experimental.imgOptConcurrency, nextConfig.experimental.imgOptOperationCache);
